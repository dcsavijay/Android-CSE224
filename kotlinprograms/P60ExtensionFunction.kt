...
functionality to the existing classes, by without inheriting
 ...
 -->if you want to use extension defined defined in one class
 somewhere else,youhave to import it at the top.
...
-->if extension function and any predefined function of a predefined class will have same name then pref will be
 given to member fxn
--> if you try to defined the member fxn of a class also as an extension fxn and both are having same name and
signature then warning of shadowing will be shown and pref will be given to member fxn

--? if you try to defined the member fxn of a class also as an extension fxn and both are having different
