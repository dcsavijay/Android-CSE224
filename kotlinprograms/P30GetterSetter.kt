...
/*Getter and setter:poperties are basically data members of a class
.Kotlin properties can declared either as mutable using
...
fun main()
{
    val c = P30GetterSetter()
    c.name = "Lovely Professional University"  // access setter
